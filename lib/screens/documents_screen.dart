          ...
          : ListView(
              ...
              children: [
                ...
                _buildUploadCard(
                  ...
                  subtitle: 'Vehicle registration license',
                  path: _document?['vehicle_license_path'],
                  icon: Icons.directions_car_outlined,
                  onTap: () => _upload('vehicle_license'),
                  isDark: isDark,
                ),
                const SizedBox(height: 12),
                _buildUploadCard(
                  title: 'Road Worthiness',
                  subtitle: 'Certificate of road worthiness',
                  path: _document?['road_worthiness_path'],
                  icon: Icons.verified_outlined,
                  onTap: () => _upload('road_worthiness'),
                  isDark: isDark,
                ),
                const SizedBox(height: 12),
                _buildUploadCard(
                  title: 'Hackney Permit',
                  subtitle: 'Commercial vehicle permit',
                  path: _document?['hackney_permit_path'],
                  icon: Icons.assignment_outlined,
                  onTap: () => _upload('hackney_permit'),
                  isDark: isDark,
                ),
              ],
            ),
